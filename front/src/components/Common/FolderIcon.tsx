...
const FOLDER_ICONS: { [key: string]: React.ReactNode } = {
  ...
  star: (
    <path
      d="M18 13.5l-1.2 1.1.3 1.7-1.5-.9-1.5.9.3-1.7-1.2-1.1 1.7-.2.7-1.5.7 1.5z"
      fill="rgba(255,255,255,0.95)"
    />
  ),
  heart: (
    <path
      d="M18 13.8c0-.5-.2-.9-.5-1.2-.7-.7-1.8-.7-2.5 0l-.5.5-.5-.5c-.7-.7-1.8-.7-2.5 0-.3.3-.5.7-.5 1.2 0 .4.2.8.5 1.1l3 2.8 3-2.8c.3-.3.5-.7.5-1.1z"
      fill="rgba(255,255,255,0.95)"
    />
  ),
  lock: (
    <path
      d="M17.5 14h-.5v-1a2 2 0 10-4 0v1h-.5a.5.5 0 00-.5.5v3a.5.5 0 00.5.5h5a.5.5 0 00.5-.5v-3a.5.5 0 00-.5-.5zm-1.5 0h-2v-1a1 1 0 112 0v1z"
      fill="rgba(255,255,255,0.95)"
    />
  ),
  shared: (
  ...
  music: (
    <path
      d="M17 11v4.5a1.5 1.5 0 11-1-1.4V12.5l3-1V11zm-3 4.5a.5.5 0 10-1 0 .5.5 0 001 0z"
      fill="rgba(255,255,255,0.95)"
    />
  ),
  photos: (
...
function FolderIcon({ color = '#5f9ee9', icon = 'default', size = 24, className = '' }: FolderIconProps) {
  ...
  return (
    ...
    >
      <path
        ...
        fill={tabColor}
      />
      <rect x="1" y="6" width="22" height="13" rx="2" ry="2" fill={folderColor} />
      <rect x="1" y="6" width="22" height="3" rx="2" ry="0" fill="rgba(255,255,255,0.12)" />
      {overlay}
    </svg>
  );
}
