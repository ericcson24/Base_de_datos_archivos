...
const ICON_PATHS: { [key: string]: React.ReactNode } = {
  image: (
    <g>
  ...
  audio: (
    <g>
      <path
        d="M12 9v5.5a1.5 1.5 0 11-1-1.4V10.5l3-.8V9zm-2 5a.5.5 0 100 1 .5.5 0 000-1z"
...
function FileTypeIcon({ type = 'file', size = 24, className = '' }: FileTypeIconProps) {
  ...
  return (
    ...
    >
      <path
        ...
        fill={config.color}
      />
      <path d="M15 1 L15 5 L19 5 Z" fill="rgba(255,255,255,0.25)" />
      <rect x="5" y="1" width="14" height="3" rx="1" ry="0" fill="rgba(255,255,255,0.08)" />
      {iconOverlay}
    </svg>
  );
}
