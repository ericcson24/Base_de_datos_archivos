...
const FileItem = ({ item, onFolderClick, onDelete, onRename, onMove, onView, onHover, onLeave, isHovered, onOpenSidebar, onEdit, onDuplicate, onDragStart, onDragEnd, viewMode = 'list' }) => {
      ...
      return (
        ...
        >
          ...
          >
            ...
            <button className="context-menu-item context-menu-danger" onClick={(e) => { e.stopPropagation(); setMenuOpen(false); onDelete(item); }}>
              🗑️ Eliminar
            </button>
          </ContextMenu>
        </div>
    ...
    viewMode === 'grid' ? (
      ...
      >
        ...
        <ContextMenu
          ...
          onClose={() => setMenuOpen(false)}
        >
          <button className="context-menu-item" onClick={(e) => { e.stopPropagation(); onFolderClick(item.name); }}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="menu-container">
          ...
          {menuOpen && (
            <div className={`mini-menu-frosted ${menuOpen ? 'show' : ''}`}>
              <button className="mini-menu-item" onClick={(e) => { e.stopPropagation(); onFolderClick(item.name); }}>
                📁 Abrir
              </button>
              <button className="mini-menu-item" onClick={(e) => { e.stopPropagation(); setMenuOpen(false); onDuplicate(item); }}>
                📋 Duplicar
              </button>
              <button className="mini-menu-item" onClick={(e) => { e.stopPropagation(); setMenuOpen(false); onMove(item); }}>
                📁 Mover
              </button>
              <button className="mini-menu-item" onClick={(e) => { e.stopPropagation(); setMenuOpen(false); onRename(item); }}>
                ✏️ Renombrar
              </button>
              <button className="mini-menu-item danger" onClick={(e) => { e.stopPropagation(); setMenuOpen(false); onDelete(item); }}>
                🗑️ Eliminar
              </button>
            </div>
          )}
